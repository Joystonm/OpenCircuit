 ...
 */
export const TamboProvider = ({ children, tamboUrl, apiKey, userToken, components, environment, tools, mcpServers, streaming, autoGenerateThreadName, autoGenerateNameThreshold, contextHelpers, contextKey, initialMessages, onCallUnregisteredTool, getResource, listResources, resources, }) => {
    return (React.createElement(TamboClientProvider, { tamboUrl: tamboUrl, apiKey: apiKey, environment: environment, userToken: userToken },
        React.createElement(TamboRegistryProvider, { components: components, tools: tools, mcpServers: mcpServers, onCallUnregisteredTool: onCallUnregisteredTool, getResource: getResource, listResources: listResources, resources: resources },
            React.createElement(TamboContextHelpersProvider, { contextHelpers: contextHelpers },
                React.createElement(TamboThreadProvider, { contextKey: contextKey, streaming: streaming, autoGenerateThreadName: autoGenerateThreadName, autoGenerateNameThreshold: autoGenerateNameThreshold, initialMessages: initialMessages },
                    React.createElement(TamboMcpTokenProvider, null,
                        React.createElement(TamboMcpProvider, { contextKey: contextKey },
                            React.createElement(TamboContextAttachmentProvider, null,
                                React.createElement(TamboComponentProvider, null,
                                    React.createElement(TamboInteractableProvider, null,
                                        React.createElement(TamboThreadInputProvider, null,
