...
var getToJsonSchemaFn = async (vendor) => {
  ...
  switch (vendor) {
    case "arktype":
      ...
      break;
    case "effect":
      vendorFnPromise = (await import("./effect-QlVUlMFu-FL2XQ6XA.js")).default();
      break;
    case "sury":
      vendorFnPromise = (await import("./sury-CWZTCd75-RN3B3JAV.js")).default();
      break;
    case "typebox":
      vendorFnPromise = (await import("./typebox-Dei93FPO-REDUBEK2.js")).default();
      break;
    case "valibot":
      vendorFnPromise = (await import("./valibot--1zFm7rT-Q5XGHFOZ.js")).default();
      break;
    case "zod":
      vendorFnPromise = (await import("./zod-Bwrt9trS-CAOIYTRC.js")).default();
      break;
    default:
...
//# sourceMappingURL=chunk-ZCCKF5ZT.js.map
